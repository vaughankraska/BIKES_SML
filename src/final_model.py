...
def generate_final_model_and_print_error_estimates():
    import numpy as np
    import pandas as pd
    ...
    print('Mega Optimistic Classification Report of final model')
    ...
    with open(f'./final_model{datetime.datetime.now()}.pkl', 'wb') as file:
        dump(final_model, file)
    # return final model in for live usage
    return final_model
